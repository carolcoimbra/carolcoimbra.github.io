...
function setYear2(id){
  ...
  d3.selectAll(".subunitSul2").style("opacity", function(){return 0.2+transferSul[idYear]/transferSum[idYear];});
  d3.selectAll(".subunitSudeste2").style("opacity", function(){return 0.2+transferSudeste[idYear]/transferSum[idYear];});
  d3.selectAll(".subunitNorte2").style("opacity", function(){return 0.2+transferNorte[idYear]/transferSum[idYear];});
  d3.selectAll(".subunitNordeste2").style("opacity", function(){return 0.2+transferNordeste[idYear]/transferSum[idYear];});
